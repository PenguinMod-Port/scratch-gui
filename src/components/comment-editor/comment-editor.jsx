...
const dropperIcon = './icon--dropper.svg';

const branchInputIcon = './icon--branch-input.svg';
const booleanInputIcon = './icon--boolean-input.svg';
const textInputIcon = './icon--text-input.svg';
const numberInputIcon = './icon--number-input.svg';
const angleInputIcon = './icon--angle-input.svg';
const colorInputIcon = './icon--color-input.svg';
const pianoInputIcon = './icon--piano-input.svg';
const emptyInputIcon = './icon--empty-input.svg';
const labelIcon = './icon--label.svg';
...
const messages = defineMessages({
    myblockModalTitle: {
        ...
        id: 'gui.commentEditor.myblockModalTitle'
    },

    forceOutputAuto: {
        defaultMessage: 'auto',
        description: 'Label for forced output shapes',
        id: 'pm.gui.commentEditor.forceOutput.0'
    },
    forceOutputHexagonal: {
        defaultMessage: 'hexagonal',
        description: 'Label for forced output shapes',
        id: 'pm.gui.commentEditor.forceOutput.1'
    },
    forceOutputRound: {
        defaultMessage: 'round',
        description: 'Label for forced output shapes',
        id: 'pm.gui.commentEditor.forceOutput.2'
    },
    forceOutputSquare: {
        defaultMessage: 'square',
        description: 'Label for forced output shapes',
        id: 'pm.gui.commentEditor.forceOutput.3'
    },
    forceOutputLeaf: {
        defaultMessage: 'leaf',
        description: 'Label for forced output shapes',
        id: 'pm.gui.commentEditor.forceOutput.4'
    },
    forceOutputPlus: {
        defaultMessage: 'plus',
        description: 'Label for forced output shapes',
        id: 'pm.gui.commentEditor.forceOutput.5'
    },
    forceOutputOctagonal: {
        defaultMessage: 'octagonal',
        description: 'Label for forced output shapes',
        id: 'pm.gui.commentEditor.forceOutput.6'
    },
    forceOutputBumped: {
        defaultMessage: 'bumped',
        description: 'Label for forced output shapes',
        id: 'pm.gui.commentEditor.forceOutput.7'
    },
    forceOutputIndented: {
        defaultMessage: 'indented',
        description: 'Label for forced output shapes',
        id: 'pm.gui.commentEditor.forceOutput.8'
    },
    forceOutputScrapped: {
        defaultMessage: 'scrapped',
        description: 'Label for forced output shapes',
        id: 'pm.gui.commentEditor.forceOutput.9'
    },
    forceOutputArrow: {
        defaultMessage: 'arrow',
        description: 'Label for forced output shapes',
        id: 'pm.gui.commentEditor.forceOutput.10'
    },
    forceOutputTicket: {
        defaultMessage: 'ticket',
        description: 'Label for forced output shapes',
        id: 'pm.gui.commentEditor.forceOutput.11'
    },
    forceOutputSlanted: {
        defaultMessage: 'slanted',
        description: 'Label for forced output shapes',
        id: 'pm.gui.commentEditor.forceOutput.12'
    },

    inputText: {
        defaultMessage: "any",
        description: "Description of the 'any' input type",
        id: "pm.gui.commentEditor.numberTextType"
    },
    inputBoolean: {
        defaultMessage: "boolean",
        description: "Description of the boolean input type",
        id: "pm.gui.commentEditor.booleanTextType"
    },
    inputNumber: {
        defaultMessage: "number",
        description: "Description of the number input type",
        id: "pm.gui.commentEditor.numberType"
    },
    inputAngle: {
        defaultMessage: "angle",
        description: "Description of the angle input type",
        id: "pm.gui.commentEditor.angleType"
    },
    inputColor: {
        defaultMessage: "color",
        description: "Description of the color input type",
        id: "pm.gui.commentEditor.colorType"
    },
    inputPiano: {
        defaultMessage: "note",
        description: "Description of the note input type",
        id: "pm.gui.commentEditor.pianoType"
    },
    inputEmpty: {
        defaultMessage: "empty",
        description: "Description of the empty input type",
        id: "pm.gui.commentEditor.emptyType"
    },
});
                ...
                >
                    ...
                    <div className={styles.optionTitle}>
                        <FormattedMessage
                            ...
                            id="gui.commentEditor.addAnInputNumberText"
                        />
                    </div>
                ...
                >
                    ...
                    <div className={styles.optionTitle}>
                        <FormattedMessage
                            ...
                            id="pm.gui.commentEditor.addAnInputCommand"
                        />
                    </div>
                    <div className={styles.optionDescription}>
                        <FormattedMessage
                            ...
                            id="pm.gui.commentEditor.commandType"
                        />
                    </div>
                </div>
                <div
                ...
                >
                    ...
                    <div className={styles.optionTitle}>
                        <FormattedMessage
                            ...
                            id="gui.commentEditor.addALabel"
                        />
                    </div>
                </div>
            </div>
            ...
            <div className={styles.checkboxRow}>
                <label>
                    ...
                    <FormattedMessage
                        ...
                        id="gui.commentEditor.runWithoutScreenRefresh"
                    />
                </label>
                <label>
                    <input
                ...
                <label>
                    <FormattedMessage
                        ...
                        description="Label for forced output shapes"
                        id="pm.gui.commentEditor.forceOutput"
                    />
                    <select
